...
Black Forest/ Elder Trophy
	SunkenCrypt4

Swamp/ Bonemass Trophy:
	MountainCave02
	Hildir_cave

Mountain/ Modor Trophy:
	Hildir_plainsfortress

Plains/ Yagluth Trophy:
	Mistlands_DvergrTownEntrance1
	Mistlands_DvergrTownEntrance2

Mistlands/ Queen Trophy:
	CharredFortress
...
based on the SLS config and players will not be able to sit at a single dungeon and reset it constantly with trophies. Server/Admin configs to allow force due scheduled 
resets 
...
should allow for this mod to reset not only to reset specific dungeons, but also slices of the world for ore, vegetation, and pickables as defined by 
SLS(StarLevelSystems) configs. 

## My only other mod
- [EpicLootAlphaTest](https://thunderstore.io/c/valheim/p/Leslie/EpicLootAlphaTest/) - Adds 6 Experimental magic effects to EpicLoot
